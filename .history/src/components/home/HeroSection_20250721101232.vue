    ...
    <div class="absolute inset-0">
      <!-- Background Image -->
        <div class="absolute inset-0 z-0">
            <Image :src="hero?.background_image" alt="Beautiful landscape" class="w-full h-full object-cover scale-105 transition-transform duration-[20s] ease-out hover:scale-110"/>
        </div>
